...
<%String word=Common.toChineseAndTrim(request.getParameter("word")); 
	...
	int cou = cb.getMessageCount("select count(*) from admin where username like '%"+word+"%'  and sf ='用户'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from admin where username like '%"+word+"%'   and sf ='用户' order by id desc",10);
...
%>       
       <tr align="center">
         ...
         <a href="<%=basePath%>AdminServlet?method=delm&id=<%=pagelist2.get(0).toString()%>">删除</a></td>
       </tr>
<% }} %>
       <tr align="center">
