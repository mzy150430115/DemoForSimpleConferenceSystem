...
<div class="title_right"><strong>用户用户管理</strong></div>  
<div style="width:900px;margin:auto;">
<form action="<%=basePath %>AdminServlet?method=upm2" method="post" name="form1">
<table class="table table-bordered">
     ...
     <td><select name="bm"> <option value="<%=bm%>"><%=bm%></option>  
