...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
		...
		String id="";String mc=""; String mm=""; 
		if(method.equals("upbm")){
			id=request.getParameter("id");
			List jlist = cb.get1Com("select * from bm where id='"+id+"'",3);
			mc=jlist.get(1).toString(); 
			mm=jlist.get(2).toString();  
		}	  
%>
<body>
...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">部门名称：</td>
     <td><input type="text" name="mc" class="span4" value="<%=mc %>" required/></td> 
     </tr>
     
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">登录密码：</td>
     <td><input type="text" name="mm" class="span4" value="<%=mm %>" required/></td> 
     </tr> 
     <tr>
