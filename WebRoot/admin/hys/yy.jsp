...
<div class="title_right"><strong>会议室预约</strong></div>  
...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">会议主题：</td>
     <td><input type="text" name="zt" class="span4"  required/></td> 
     </tr>
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">预约日期：</td>
     <td><input type="date" name="rq" class="span2"  required/></td> 
     </tr>
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">参与人：</td>
     <td><input type="text" name="cyr" class="span4"  required/></td> 
     </tr>
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">主持人：</td>
     <td><input type="text" name="zcr" class="span4"  required/></td> 
     </tr>
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">会议类型：</td>
     <td><input type="text" name="lx" class="span4"  required/></td>  
     </tr> 
     <tr>
